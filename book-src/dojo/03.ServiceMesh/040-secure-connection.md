...
Za účelom vydávania certifikátov nasadíme do klastra službu [cert-manager]. Cert-manager podporuje niekoľko vlastných zdrojov, v našom prípade budeme využívať najme zdroje typu [_Issuer_](https://cert-manager.io/docs/concepts/issuer/) a nepriamo zdroj typu [_Certificate_](https://cert-manager.io/docs/concepts/certificate/), ktorý bude za nás vytvárať _cert-manager_ na základe anotácii umietnených na našom objekte [_Gateway_](https://cert-manager.io/docs/usage/gateway/)
