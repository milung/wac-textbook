...
Pri vytvárani web service budeme postupovať technikou [_API First Design_](https://www.programmableweb.com/api-university/understanding-api-first-design).
Táto technika umožňuje dosiahnuť lepšiu použiteľnosť API aj menej skúseným
softvérovým inžinierom.

1. V prehliadači otvorte stránku [Swagger Hub](https://app.swaggerhub.com/home)
  a prejdite na časť _My Hub_. Zvoľte položky _Create New -> Create New API_.
  ...
  _Visibility_ podľa vlastného uváženia, _Auto Mock API_ "ON"
    ...
    Po vytvorení API uvidíte v prehliadači špecifikáciu jednoduchého predpripraveného
    API

    Upravte YAML definíciu vášho API:
                      ...
                      value:
                        ...
                        waitingList:
                          - id: x321ab3
                            ...
                            waitingSince: '2018-12-24T10:05:00.000Z'
                            estimatedStart: '2018-12-24T10:35:00.000Z'
                          ...
                          - id: x321ab4
                            ...
                            waitingSince: '2018-12-24T10:25:00.000Z'
                            estimatedStart: '2018-12-24T10:50:00.000Z'
    ...
    Použitím _Auto Mocking_ voľby, sme získali možnosť vyskúšať ako sa naše API správa.
    Táto možnosť nám umožňuje zverejniť API ešte pred tým než máme pripravenú jeho
    ...
    Tento postup znižuje náklady na zmenové konanie API, najmä v prípadoch kde
    implementácia API a jeho použitie je distribuované medzi rozličné tímy. Na
    odskúšanie tejto funkcionality je potrebné do nami zmenenej YAML definície
    špecifikovať url mockup serveru v poli `servers`:
    ```yaml
    openapi: 3.0.0
    servers:
      - description: SwaggerHub API Auto Mocking
        url: https://virtserver.swaggerhub.com/<username>/AmbulanceWaitingList/1.0.0
    info:
    ...
    ```

2. Rozbaľte detaily metódy `GET /waitning-list/{ambulanceId}` a zvoľte tlačidlo
...
V tomto kroku máme našu špecifikáciu API pripravenú na implementáciu, a môžeme
začať s implementáciou služby s pomocou knižnice _ASP.NET Core 5.0_
